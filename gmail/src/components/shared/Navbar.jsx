            ...
            <AnimatePresence>
              {
                toggle && (
                  <motion.div
                    ...
                    className='absolute right-2 x-20 shadow-lg bg-white rounded-md'
                  >
                    <p onClick={signOutHandler} className='p-2 underline text-red-600'>LOGOUT</p>
                  </motion.div>
                )
              }
            </AnimatePresence>
